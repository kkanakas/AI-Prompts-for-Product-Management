...
```
Context:
We are writing a Product Requirement Document for [PRODUCT DESCRIPTION]
targeting [TARGET MARKET].
We are considering [STRATEGIC QUESTION].
I have attached the following information:
- [LIST ATTACHED DOCUMENTS: slack messages, emails, meeting transcripts,
...
|-------------|-----------------------------------------------------------------------------------------------------|
| [MILESTONE] | As a [Persona], I should be able to do [FUNCTION] given [SITUATION] |
```
...
| `[STRATEGIC QUESTION]` | Are we planning to Accelerate a capability, Expand a capability, or Simplify a complex capability — or are we doing 2 or all of these |
